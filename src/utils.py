...
ANNOTATIONS_MIGRATE_DIR = make_path(OUT_DIR / "annotations_migrate", True)
MANIFESTS_MIGRATE_DIR = make_path(OUT_DIR / "manifests_migrate", True)
SAVE_OK_FILE_ANNOTATIONS = Path(OUT_DIR / "save_ok_annotations.json")
SAVE_ERR_FILE_ANNOTATIONS = Path(OUT_DIR / "save_err_annotations.json")
SAVE_OK_FILE_MANIFESTS = Path(OUT_DIR / "save_ok_manifests.json")
SAVE_ERR_FILE_MANIFESTS = Path(OUT_DIR / "save_err_manifests.json")
